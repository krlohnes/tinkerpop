...
import org.apache.tinkerpop.gremlin.server.handler.HttpAuthenticationHandler;
...
public class HttpChannelizer extends AbstractChannelizer {
    ...
    private HttpAuthenticationHandler authenticationHandler;
    ...
    private HttpAuthenticationHandler createAuthenticationHandler(final Settings settings) {
        final String handlerClassName = settings.authentication.httpAuthHandlerClassName;
